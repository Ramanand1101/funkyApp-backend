...
orderRouter.post("/placed", authMiddleware, async (req, res) => {
    try {
        const {items,cartTotal} = req.body;
        ...
        const order = new Order({ 
            ...
            paymentStatus: "pending" // Default status is set to "pending"
            // Add other necessary fields to the order schema
        });
